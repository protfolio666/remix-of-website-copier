...
function ContactPage() {
  ...
  return (
    <div className="pt-32">
      <PageHero chapter="04" label="Contact">
      ...
      <StickyChapter number="04 — Contact" title="Details & message.">
        <div className="grid gap-16 lg:grid-cols-12">
          <div className="space-y-10 lg:col-span-5">
            <ScrollReveal>
              <div>
                <p className="text-xs uppercase tracking-[0.3em] text-muted-foreground">Email</p>
                <a href="mailto:abhishek@solvextra.com" className="mt-2 block font-display text-3xl hover:text-accent">
            ...
            <ScrollReveal>
              <div className="border-t border-border pt-8">
                ...
                <ul className="mt-4 flex flex-wrap gap-2">
                  {openTo.map((o) => (
                    <li key={o} className="border border-border px-3 py-1.5 text-xs">
                      {o}
                    </li>
                  ))}
                </ul>
            ...
            <ScrollReveal>
              <div className="flex flex-wrap gap-3 text-[11px] uppercase tracking-[0.3em]">
                <a href="#" className="border border-foreground/40 px-5 py-3 hover:border-accent hover:text-accent">
                  Download Resume
                </a>
                <a
                  href="https://linkedin.com/in/abhi003"
                  target="_blank"
                  rel="noreferrer"
                  className="border border-foreground/40 px-5 py-3 hover:border-accent hover:text-accent"
                >
                  LinkedIn ↗
                </a>
              </div>
